          ...
          <n-collapse>
            <n-collapse-item title="Apple Music Like Lyrics 设置">
              ...
              <div class="name" style="margin-top: 16px">
                使用AMLL弹簧渲染效果
                <n-text class="tip"> 开启本项会使用Apple Music-Like Lyrics组件的弹簧效果 </n-text>
              </div>
              ...
              <div class="name" style="margin-top: 16px">
                ...
                <n-text class="tip">
                  开启本项后，歌词将使用TTML格式歌词, 会从SteveXMH的歌词仓库获取TTML歌词,
                  如果没有TTML歌词则回退使用LRC歌词
                </n-text>
              </div>
