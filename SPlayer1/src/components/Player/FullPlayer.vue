      ...
      <Transition name="fade" mode="out-in">
        ...
        >
              ...
              <div class="desc">
                <div class="title">
                  ...
                  <n-popover :show-arrow="false" placement="right-start" trigger="hover" raw>
                    ...
                    >
                      <span
                        >已经使用UnblockNeteaseMusic的第三方音源, 可能会出现匹配不准确的问题</span
                      >
                    </div>
                  </n-popover>
                </div>
          ...
          <div v-if="playMode !== 'dj'" :class="['right', { pure: pureLyricMode && isHasLrc }]">
            ...
            <!-- AMLL歌词组件 -->
            <AMLyric v-else :cursorShow="playerControlShow" class="amll-lyric-container" />
          </div>
        </div>
      </Transition>
      <!-- 控制中心 -->
...
const { playerBackgroundType, showYrc, playCoverType, showSpectrums, useAMLyrics } =
